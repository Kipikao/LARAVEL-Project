<x-appo-layout>
    ...
    <form method="post" action="{{ route('updateQuestion', ['id' => $question])}}">
        @csrf
        @method('put')
        <div class="py-6">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div class="mt-6 border-t border-white/10">
                        <dl class="divide-y divide-white/10">
                            ...
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                                ...
                                <dd class="mt-1 text-sm leading-6 text-gray-900 dark:text-gray-100 sm:col-span-2 sm:mt-0">{{ $question->status }}<input class="border-gray-300 dark:border-gray-700 
                            dark:bg-gray-900 dark:text-gray-300 
                            focus:border-indigo-500 dark:focus:border-indigo-600 
                            focus:ring-indigo-500 dark:focus:ring-indigo-600 rounded-md 
                            shadow-sm mt-1 block w-full" type="text" name="status" /></dd>
                            </div>
                            <div class="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-0">
                ...
                <div class="button_style">
                    <x-cancel-button>
                        <a href="{{ route('viewQuestion', ['id' => $question])}}">Anulează</a>
                    </x-cancel-button>

                    <x-red_action-button>Trimite răspunsul
                    </x-red_action-button>
                </div>
            </div>
        </div>
    ...
    <div class="px-4 sm:px-6 lg:px-8">
        <div class="sm:flex sm:items-center">
            <div class="sm:flex-auto">
                <h1 class="bannerQue1 font-semibold leading-6 text-gray-900">Lista cu toate întrebările</h1>
    ...
    <p class="bannerQue">Pagină răspuns întrebări</p>


    <img src="{{ asset('img/queedit.png') }}" alt="Pagina intrebari">
